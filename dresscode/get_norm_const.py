...
def get_opt():
    ...
    parser.add_argument('--D_checkpoint', type=str, default='./checkpoints/train/tocg_final.pth', help='tocg checkpoint')
    parser.add_argument('--tocg_checkpoint', type=str, default='./checkpoints/train/D_final.pth', help='tocg checkpoint')
