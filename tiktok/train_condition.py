...
def get_opt():
    ...
    # parser.add_argument("--test_dataroot", default="./data/dresscode")
    parser.add_argument("--test_dataroot", default="./data/tiktok")
    parser.add_argument("--test_data_list", default="test_unpairs.txt")
    

    # Hyper-parameters
    parser.add_argument('--G_lr', type=float, default=0.00005, help='Generator initial learning rate for adam')
...
def main():
    ...
    if not opt.no_test_visualize:
        ...
        val_dataset = Subset(test_dataset, np.arange(1799))
