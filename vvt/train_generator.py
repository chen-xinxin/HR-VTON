...
def get_opt():
    ...
    parser.add_argument('--name', type=str, default='train', required=True)
    ...
    parser.add_argument('--tocg_checkpoint', type=str,default='./checkpoints/train/tocg_final.pth', help='condition generator checkpoint')
    ...
    parser.add_argument("--test_dataroot", default="./data/192_256")
